namespace HuaweiARUnitySDK
{
    ...
    public class BackGroundRenderer : MonoBehaviour
    {
        ...
        private static readonly int YTex = Shader.PropertyToID("_YTex");
        ...
        public void Update()
        {
            ...
            BackGroundMaterial.SetVector(leftTopBottom,
                new Vector4(transformedUVCoords[0], transformedUVCoords[1], transformedUVCoords[2],
                    transformedUVCoords[3]));
            BackGroundMaterial.SetVector(rightTopBottom,
                new Vector4(transformedUVCoords[4], transformedUVCoords[5], transformedUVCoords[6],
        ...
        {
            BackGroundMaterial.SetTexture(YTex, y_tex);
